...
// Admin: Assign a volunteer to a complaint
export const assignVolunteer = async (complaintId, volunteerId) => {
  const res = await api.patch(`/complaints/${complaintId}/assign`, { volunteerId });
